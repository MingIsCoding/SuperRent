...
class TenantFavoriteViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Edit", style: .Plain, target: self, action: #selector(TenantFavoriteViewController.toggleEdittingMode))
    ...
    func requestForData() {
        ...
        query.whereKey("favedBy", containsString: userEmail)
